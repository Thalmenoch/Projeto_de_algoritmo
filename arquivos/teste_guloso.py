def linha_de_montagem_guloso(tempo, troca, entrada, saida):
    ...
    tempo_total = [[0] * estacao for _ in range(2)]  # Aqui é difinido a matriz para armazenar os tempos totais

    # Definição dos tempos iniciais
    tempo_total[0][0] = entrada[0] + tempo[0][0]
    tempo_total[1][0] = entrada[1] + tempo[1][0]

    # Preenchimento da matriz de tempos totais
    ...
    # Calculo do tempo total mínimo de montagem, ou seja,
    ...
    # Recuperação da solução encontrada
    caminho = []
